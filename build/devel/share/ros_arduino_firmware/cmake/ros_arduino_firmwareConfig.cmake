...
if("TRUE" STREQUAL "TRUE")
  set(ros_arduino_firmware_SOURCE_PREFIX /home/lostm/文档/arduino_ws/src/ros_arduino_bridge-indigo-devel/ros_arduino_firmware)
  set(ros_arduino_firmware_DEVEL_PREFIX /home/lostm/文档/arduino_ws/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lostm/文档/arduino_ws/src/ros_arduino_bridge-indigo-devel/ros_arduino_firmware/${idir}'.  ${_report}")
    endif()
