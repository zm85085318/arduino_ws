...
bool operator==(const ::ros_arduino_msgs::DigitalSetDirectionRequest_<ContainerAllocator1> & lhs, const ::ros_arduino_msgs::DigitalSetDirectionRequest_<ContainerAllocator2> & rhs)
{
