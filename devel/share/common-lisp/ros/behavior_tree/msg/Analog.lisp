...
(cl:defmethod cl:initialize-instance :after ((m <Analog>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Analog)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name behavior_tree-msg:<Analog> is deprecated: use behavior_tree-msg:Analog instead.")))
...
(cl:defmethod value-val ((m <Analog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader behavior_tree-msg:value-val is deprecated.  Use behavior_tree-msg:value instead.")
  (value m))
