...
class RobotStatusControllerResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotStatusControllerResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotStatusControllerResult(null);
...
module.exports = RobotStatusControllerResult;
