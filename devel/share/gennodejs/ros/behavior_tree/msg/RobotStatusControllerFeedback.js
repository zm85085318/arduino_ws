...
class RobotStatusControllerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotStatusControllerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotStatusControllerFeedback(null);
...
module.exports = RobotStatusControllerFeedback;
