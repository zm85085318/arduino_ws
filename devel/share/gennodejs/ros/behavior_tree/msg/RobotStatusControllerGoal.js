...
class RobotStatusControllerGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotStatusControllerGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotStatusControllerGoal(null);
...
module.exports = RobotStatusControllerGoal;
