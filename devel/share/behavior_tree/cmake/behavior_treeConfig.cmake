...
if("TRUE" STREQUAL "TRUE")
  set(behavior_tree_SOURCE_PREFIX /home/lostm/文档/arduino_ws/src/behavior_tree)
  set(behavior_tree_DEVEL_PREFIX /home/lostm/文档/arduino_ws/devel)
  ...
  set(behavior_tree_INSTALL_PREFIX /home/lostm/文档/arduino_ws/install)
...
if(NOT "/home/lostm/文档/arduino_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'behavior_tree' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lostm/文档/arduino_ws/src/behavior_tree/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;message_runtime;move_base_msgs;actionlib")
